...
public class ThreadTest19 {
	...
	public static void main(String[] args) {
		...
		ConsumeerThread th2 = new ConsumeerThread(databox);
...
class DataBox{
	...
	//     value변수가 null이 되면 새로운 데이터 값을 저장한다.
...
// 데이터를 꺼내서 사용하는 쓰레드
class ConsumeerThread extends Thread{
	
	private DataBox box;

	public ConsumeerThread(DataBox box) {
		this.box = box;
	}
