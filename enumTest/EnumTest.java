 ...
 *        original() ==> 열거형 상수가 정의된 순서값(index)을 반환한다. (0부터 시작)
 *        valueOf("열거형 상수명") ==> 지정된 열거형에서 '열겨형상수명'과 일치하는
 *               열거형 상수를 반환한다.
...
public class EnumTest {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("mycol original : " + mycol.ordinal());
		System.out.println();
...
//		}
		...
		case TWO : System.out.println("THREE");
		...
		System.out.println("temp : " + ss.getClass());
		System.out.println();
